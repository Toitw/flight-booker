    ...
    def index
      ...
      if params[:flight].present?
        ...
        if departure_airport_id.present? && arrival_airport_id.present?
          @available_flights = Flight.where(departure_airport_id: departure_airport_id, arrival_airport_id: arrival_airport_id, start: departure_date.to_datetime.beginning_of_day..departure_date.to_datetime.end_of_day)
        else
          @available_flights = []
        end
      else
